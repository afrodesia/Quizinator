angular.module('App')
	.controller('quiztCtrl', QuizController)	;
...
var dataFruit = [
			...
			},
			{
				...
				"description": "Fragrantly sweet strawberries are the most popular type of berry fruit in the world. Although they have become increasingly available year-round, they are at the peak of their season from April through July when they are the most delicious and most abundant."				
			},
			{
				"name": "Lemons",
				"type": "fruits",
				"image": "/data/img/lemon-1117568_640.jpg",
				"description": "Bionomically known as Citrus Limon this fruit belongs to the Rutaceae family in the genus citrus which is also a home to the prominently and widely consumed fruits such as pomelo, tangerine, grapefruit, and oranges. This small round shaped fruit has a deceptive size as it houses many health benefiting nutrients that is even better than larger fruits belonging to this family." 
			...
			},
			{
				...
				"description": "Cantaloupe fruit is also called as mushmelon, muskmelon, cantalope, rockmelon or spanspek which all together refers a variety of Cucumis melo, comes under the family Cucurbitaceae which includes nearly all melons and squashes." 
			...
			},
			{
				...
				"description": "Watermelon, the fruit which is really a Vegetable.Watermelon can be traced back to Africa and it is part of the cucumber and squash family. Early watermelons were mostly rind and seeds. Today's varieties are larger, the flesh is sweeter, the seeds are smaller and the rind is thinner. It is the most refreshing, thirst satisfying fruit of all. It consists of 92% water and 8% sugar, so it is appropriately named." 
			...
			},
			{
				...
				"description": "The Rusty Plum is a small to medium-sized tree to 20 m high with a very fluted or irregular trunk. The young shoots have rusty hairs, and the shoots and stems exude white milky sap if cut. The leaves are alternate, 5 - 15 cm long and 2 - 5 cm wide with a firm texture and a 'quilted' appearance. " 
			}			
